                                  ...
                                  <div class="up_form-item">
                                    ...
                                    <div class="up_form-item text-right">
                                        ...
                                        <label>
                                            <a href="trainer-privacy.html" class="show-privacy">تعرف علي سياسة الخصوصية كمتدرب</a>
                                                ...
                                                <label>
                                                  <a  href="{{route('courses') }}"  style="color:green" class="show-privacy2">
                                    ...
                                    <div class="up_form-item up-confirm">
                                        <input type="submit" value="تسجيل">
                                            ...
                                            <a href="{{route('lectuer.register') }}" data-toggle="tooltip" data-placement="top" style="color:blue" title="lecturer">
                                      
                                   register as lectuer </a>
                                    <!-- /.up_form-item -->
                                </form>
